...
import com.android.internal.net.http.HttpDateTime;
 ...
 */
public final class DataDroidHttpClient implements HttpClient {
    ...
    private static final String TAG = "DataDroidHttpClient";
     ...
     * @return DataDroidHttpClient for you to use for all your requests.
     */
    public static DataDroidHttpClient newInstance(String userAgent, Context context) {
        ...
        return new DataDroidHttpClient(manager, params);
    }
     ...
     * @return DataDroidHttpClient for you to use for all your requests.
     */
    public static DataDroidHttpClient newInstance(String userAgent) {
    ...
    private RuntimeException mLeakedException = new IllegalStateException(
            "DataDroidHttpClient created and never closed");

    private DataDroidHttpClient(ClientConnectionManager ccm, HttpParams params) {
